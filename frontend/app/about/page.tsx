...
const SECTIONS: [title: string, slug: string, desc: string][] = [
  ...
  ['شعر', 'شعر', 'قصائد من مختلف أشكال الكتابة الشعرية'],
  ['سرد', 'سرد', 'قصص قصيرة وروايات ومقاطع سردية'],
  ['قراءات', 'قراءات', 'مراجعات نقدية للأعمال الأدبية والفكرية'],
  ['فكر', 'فكر', 'مقالات في الفلسفة والفكر والعلوم الإنسانية'],
  ['حوار', 'حوار', 'حوارات مع الكتّاب والمفكرين والمبدعين'],
  ['ترجمة', 'ترجمة', 'نصوص مترجمة من الأدب العالمي'],
  ['إصدارات', 'إصدارات', 'عروض للكتب والمنشورات الجديدة'],
];
