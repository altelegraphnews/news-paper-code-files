...
const GUIDELINES = [
  ...
  'يُشترط أن تكون الأعمال المقدَّمة مكتوبةً بلغةٍ سليمة، ونعتذر عن قبول أيّ مادة تثير الحساسيات الطائفية أو العنصرية.',
  'يُستحسن أن يرافق العملَ نبذةٌ قصيرة عن الكاتب وصورةٌ شخصية.',
  'تُعلم هيئة التحرير أصحابَ الأعمال بقرارها خلال مدّةٍ تتراوح بين يومٍ وأربعة أيامٍ من تاريخ الاستلام.',
  'ستكون جميع إسهاماتكم محطَّ اهتمامٍ كاملٍ من هيئة التحرير.',
];
